...
buttn_edytuj_obiekt = Button(ramka_lista_obiektow, text='Edytuj obiekt')
buttn_edytuj_obiekt.grid(row=3, column=2)

#ramka_formularz

label_formularz=Label(ramka_formularz, text='Formularz')
label_formularz.grid(row=0, column=2, columnspan=2)
